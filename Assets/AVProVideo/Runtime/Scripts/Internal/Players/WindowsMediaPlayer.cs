...
namespace RenderHeads.Media.AVProVideo
{
	...
	public /*sealed*/ partial class WindowsMediaPlayer : BaseMediaPlayer
	{
		...
		public WindowsMediaPlayer(MediaPlayer.OptionsWindowsUWP options) : base()
		{
			...
			SetOptions(api, audioOutput, options.useHardwareDecoding, options.useTextureMips, options.use10BitTextures, false, options.useLowLatency, string.Empty, null, false, 1, 0, false, true);
		}
...
#if SUPPORT_TEXTURE_POOL
				System.Int64 timeStamp = _textureFrame.timeStamp;				if (Native.LockTextureFrame(_instance, ref _textureFrame))
				{
					newPtr = _textureFrame.texturePointer;
					System.Int64 d = _textureFrame.timeStamp - timeStamp;
					if (d > 333334)
					{
						Debug.Log(d);
					}
					//Native.UnlockTextureFrame(_instance);
				}
#endif
		...
		private partial struct Native
		{
			...
			[return: MarshalAs(UnmanagedType.I1)]
#endif			
			public static extern bool LockTextureFrame(System.IntPtr instance, ref TextureFrame textureFrame);

			[DllImport("AVProVideo")]
			public static extern void UnlockTextureFrame(System.IntPtr instance);
