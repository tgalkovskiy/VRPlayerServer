            ...
            case ControllerDevice.G2:
                {
                    if (Pvr_UnitySDKAPI.Controller.UPvr_IsTouching(0))
                    {
                        ...
                        transform.localPosition = new Vector3(1.3f - Pvr_UnitySDKAPI.Controller.UPvr_GetTouchPadPosition(hand).x * 0.01f, 1.6f, -1.7f - Pvr_UnitySDKAPI.Controller.UPvr_GetTouchPadPosition(hand).y * 0.01f);
                    }
                    else
                    {
