...
#region Public Interfaces
    ...
    private void SetSystemKey()
    {
        ...
        {
            if (Pvr_UnitySDKAPI.Controller.UPvr_GetKeyLongPressed(0, Pvr_KeyCode.HOME) || Pvr_UnitySDKAPI.Controller.UPvr_GetKeyLongPressed(1, Pvr_KeyCode.HOME))
            {
        ...
        if (controllerlink.picoDevice)
        {
            if (controllerlink.switchHomeKey)
            {
                if (Pvr_UnitySDKAPI.Controller.UPvr_GetKeyClick(0, Pvr_KeyCode.HOME) || Pvr_UnitySDKAPI.Controller.UPvr_GetKeyClick(1, Pvr_KeyCode.HOME) && !stopConnect)
                {
        ...
        if (controllerlink.goblinserviceStarted)
        {
            if (Pvr_UnitySDKAPI.Controller.UPvr_GetKey(0, Pvr_KeyCode.HOME) && Pvr_UnitySDKAPI.Controller.UPvr_GetKey(0, Pvr_KeyCode.VOLUMEDOWN) && !stopConnect)
            {
