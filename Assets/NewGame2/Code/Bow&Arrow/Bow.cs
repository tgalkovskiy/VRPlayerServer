...
public class Bow : MonoBehaviour, IPooledObject
{
    [Header("Bow")]
    ...
    {
        GameObject obj = objectPooler.SpawnFromPool("Arrow", m_Socket.transform, new Vector3(0, 0, 0.425f), Vector3.zero);

        // Set the current arrow
        m_CurrentArrow = obj.GetComponent<Arrow>();
    }
